...
class Game:
    ...
    def messages_to_screen(self,msg, color, lokatie1, lokatie2):  # massage hoe hij er uit moet zien en waar
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_UP:
                        while questions.messages_to_screen(self):
                            if self == "Correct":
...
class questions:  # vragen op het scherm
    ...
    def messages_to_screen(self,msg, color, lokatie1, lokatie2):  # massage hoe hij er uit moet zien en waar
         ...
         while not correct:
                ...
                self.messages_to_screen(l[random_selection].questions[0], black, 20, 50)
                self.messages_to_screen(l[random_selection].answer1[0], black, 20, 5)
                self.messages_to_screen(l[random_selection].answer2[0], black, 2, 5)
                self.messages_to_screen(l[random_selection].answer3[0], black, 1, 5)
                self.messages_to_screen("Kies A , B , C ", black, 9, 4)
                pygame.display.flip()
