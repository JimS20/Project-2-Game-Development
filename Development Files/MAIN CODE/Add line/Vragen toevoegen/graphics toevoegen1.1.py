...
Karak1 = pygame.image.load('images/Assassin5.png')
Karak2 = pygame.image.load('images/Soldier2.png')
Karak3 = pygame.image.load('images/Pirate2.png')
Karak4 = pygame.image.load('images/Taxman2.png')
...
class Game2Player:
    def __init__(self):
        ...
        #Create player
        self.Player1 = Player(320,430,Karak1,1)
        self.Player2 = Player(270,430,Karak2,2)
...
class Game3Player:
    def __init__(self):
        ...
        self.Player1 = Player(320, 430,Karak1,1)
        self.Player2 = Player(270,430,Karak2,2)
        self.Player3 = Player(220,430,Karak3,3)
...
class Game4Player: # (Gelderen, 2016)
    def __init__(self):
        ...
        self.Player2 = Player(270,430,Karak2,2)
        self.Player3 = Player(220,430,Karak3,3)
        self.Player4 = Player(370,430,Karak4,4)
...
class Player:
   ...
   def draw(self, screen):
            screen.blit(self.color, (int(self.posX), int(self.posY)))

   def drawturn(self,screen):
            screen.blit(self.color, (440,320))
...
class Lines:
    def draw(self,screen):
        ...
        #zwarte lijnen
        pygame.draw.line(screen,black,(0,110),(500,110),5)
        pygame.draw.line(screen,black,(0,150),(500,150),5) 
        pygame.draw.line(screen,black,(0,190),(500,190),5)
        pygame.draw.line(screen,black,(0,230),(500,230),5)

        pygame.draw.line(screen,black,(0,270),(500,270),5)
        pygame.draw.line(screen,black,(0,310),(500,310),5) 
        pygame.draw.line(screen,black,(0,350),(500,350),5)
        pygame.draw.line(screen,black,(0,390),(500,390),5)

        pygame.draw.line(screen,black,(0,430),(500,430),5)
        pygame.draw.line(screen,black,(0,470),(500,470),5)
